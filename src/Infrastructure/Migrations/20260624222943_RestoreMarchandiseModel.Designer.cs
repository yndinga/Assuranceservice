...
namespace AssuranceService.Infrastructure.Migrations
{
    ...
    [Migration("20260624222943_RestoreMarchandiseModel")]
    partial class RestoreMarchandiseModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AssuranceService.Domain.Models.Marchandise", b =>
                {
                    b.HasOne("AssuranceService.Domain.Models.Assurance", "Assurance")
                        .WithOne("Marchandise")
                        .HasForeignKey("AssuranceService.Domain.Models.Marchandise", "AssuranceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
